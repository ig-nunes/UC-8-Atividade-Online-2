...
Obs.2: O valor de quantn não é igual ao tamanho do listpartn, foi usado apenas para atender o requisito. Com isso, por favor,
ignorar se o limite de uma lista tiver sido alcançada, visto que as listas não terão 100 valores);
